...
namespace CTRPluginFramework
{
    namespace GuiRenderer
    {
        namespace
        {
            ...
            //   ★Simulator 670e44f（2026-09-25）: F 印 x11（2 字）、説明欄の操作の文字 x1（28 字。最長
            //     "START:CLOSE  A:SELECT" 21 字）、通知が複数行になった分 x12（16 字。高さで押し上げる方式なので
            //     見える行は画面の高さで決まる。最大の見積もりは verify_plugin_port_v2.py 群 5 の 7）。
            const u8    kTopSlotCaps[] = {
                 2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,
                 2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,     // F 印
                ...
                16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,     // 通知の 3 行目以降・8 件目以降
                16,                             // 長押しの表示
